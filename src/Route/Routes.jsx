...
import BusinessSignup from "../Auth/RegisterForms/BusinessSignup";
...
export const routes = [
...

  {
    ...
    Component: <FormValidationContain />,
  },
  {
  ...
  {
    path: `${process.env.PUBLIC_URL}/dashboard/business-register`,
    Component: <BusinessSignup />,
  },
  {
    path: `${process.env.PUBLIC_URL}/dashboard/category-list`,
    Component: <CategoryList />,
  },
  {
    path: `${process.env.PUBLIC_URL}/dashboard/create-category`,
    Component: <CategoryForm />,
  },
  {
    path: `${process.env.PUBLIC_URL}/dashboard/create-subcategory`,
  ...
  //Project
  {
    path: `${process.env.PUBLIC_URL}/project/project-list`,
    Component: <Project />,
  },
  {
    path: `${process.env.PUBLIC_URL}/project/new-project`,
    Component: <CreateListContain />,
  },
  {
    path: `${process.env.PUBLIC_URL}/kanban-board`,
    Component: <KanbanBoard />,
  },
  {
    path: `${process.env.PUBLIC_URL}/file-manager`,
  ...
  {
    path: `${process.env.PUBLIC_URL}/ecommerce/product-page/1`,
  ...
  {
    path: `${process.env.PUBLIC_URL}/ecommerce/payment-details`,
  ...
  {
    path: `${process.env.PUBLIC_URL}/email-app/compose`,
    Component: <Compose />,
  },
  ...
  {
    path: `${process.env.PUBLIC_URL}/table/reactstraptable`,
  ...
  },
  {
    ...
    Component: <JobCardsContain />,
  },
  {
    path: `${process.env.PUBLIC_URL}/knowledgebase/knowledgecategory`,
  ...
  {
    path: `${process.env.PUBLIC_URL}/knowledgebase/KnowledgeDetailContain`,
  ...
  {
    path: `${process.env.PUBLIC_URL}/editor/acecodeeditor`,
  ...
  },
  {
    ...
    Component: <TimeLineContain />,
  },
  {
    path: `${process.env.PUBLIC_URL}/ecommerce/pricing`,
    Component: <PricingMembershipContain />,
  },
  {
    path: `${process.env.PUBLIC_URL}/ecommerce/whishlist`,
    Component: <WhishList />,
  },
  ...
  },
  {
    ...
    Component: <FormTypeaheadContain />,
  },
  {
  ...
  {
    path: `${process.env.PUBLIC_URL}/form-widget/Select`,
    Component: <Select />,
  },
  {
  ...
  {
    path: `${process.env.PUBLIC_URL}/ecommerce/Add-product`,
    Component: <LeftformDesc />,
  },
];
